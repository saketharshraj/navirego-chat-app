        ...
        try {
            ...
            if (response.success) {
                if (initial) {
                    ...
                    setHasMore(
                        0 + response.data.data.length <= response.data.total,
                    );
                    ...
                    setTotalMessageLength(response.data.total);
                    setHasMore(
                        messageListLength + response.data.data.length <=
                            response.data.total,
                    );
                    setMessageListLength(
                        messageListLength + response.data.data.length,
                    );
                }
            } else {
    ...
    return (
        <>
            ...
            <MessageInput
                ...
                setMessageListLength={setMessageListLength}
                setTotalMessageLength={setTotalMessageLength}
            />
        </>
    );
};
