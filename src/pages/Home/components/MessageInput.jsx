...
const MessageInput = ({
    ...
    const handleSendMessage = async () => {
        ...
        setMessageList((prevList) => [userInput, ...prevList]);
        ...
        try {
            ...
            setMessageList((prevList) => [botResponse, ...prevList]);
                ...
                <Container maxWidth={'md'}>
                    <Box width={'100%'} textAlign={'center'}>
                        ...
                        <Box
                            ...
                            my={{ xs: 1, md: 2 }}
                        >
                            Chatbot responses are generated by AI and may not
                            always be accurate.
                        </Box>
                    </Box>
                </Container>
